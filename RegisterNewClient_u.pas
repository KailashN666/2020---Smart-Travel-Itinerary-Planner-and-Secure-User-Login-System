...
procedure TfrmRegisterNewClient.btnCloseProgramClick(Sender: TObject);
begin
...
begin
  SetAsMainForm(frmRegisterNewClient);
...
begin
  ...
  Begin
    ...
    edtEmail.Color := clBtnShadow;
  End;
end;

procedure TfrmRegisterNewClient.SetAsMainForm(aForm: TForm);
Var
  P : Pointer;
begin

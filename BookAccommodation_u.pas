...
begin
  ...
  case iIndex of
    1 : Begin
          img1.Picture.LoadFromFile('1\1.jpg');
          img2.Picture.LoadFromFile('1\2.jpg');
          img3.Picture.LoadFromFile('1\3.jpg');
          img4.Picture.LoadFromFile('1\4.jpg');
        ...
        End;
    2 : Begin
          img1.Picture.LoadFromFile('2\1.jpg');
          img2.Picture.LoadFromFile('2\2.jpg');
          img3.Picture.LoadFromFile('2\3.jpg');
          img4.Picture.LoadFromFile('2\4.jpg');
        ...
        End;
    3 : Begin
          img1.Picture.LoadFromFile('3\1.jpg');
          img2.Picture.LoadFromFile('3\2.jpg');
          img3.Picture.LoadFromFile('3\3.jpg');
          img4.Picture.LoadFromFile('3\4.jpg');
...
var
  I: Integer;
begin
  SetAsMainForm(frmAccommodation);

  sDestination := FunctionsAndProcedures_u.sDestination;
  sDestinationID := FunctionsAndProcedures_u.sDestinationID;

  lblDestinationChoice.Caption := 'These are the choices of ' +#13+ 'Hotels at : ' +  sDestination;
...
begin
  ...
  Begin
    ...
    lblCost.Caption := 'The cost of a stay per night is ' +#13+ FloatToStrF(qryTravelNow.FieldByName('CostPerNight').AsFloat, ffCurrency, 6, 2);
  End;
end;
...
procedure TfrmAccommodation.SetAsMainForm(aForm: TForm);
Var
  P : Pointer;
begin
